...
import { Usuario } from '../../autenticacion/interface/Usuario.interface';

@Component({
  selector: 'app-inputforn',
  templateUrl: './inputforn.component.html',
})
export class InputfornComponent{
